...
if ($videos) { ?>
	<div class="cVideoIndex">
		<ul class="cVideoItems">
			...
			?>
			<li id="<?php echo "video-" . $v->getId() ?>" class="cVideoItem">
				<div class="cVideoItem">

					<div class="cVideoThumb" style="width: <?php echo $videoThumbWidth; ?>px; height:<?php echo $videoThumbHeight; ?>px;">
						...
						<?php else: ?>            
							<a class="cVideoThumbUrl" href="<?php echo $v->getURL(); ?>" style="width: <?php echo $videoThumbWidth; ?>px; height:<?php echo $videoThumbHeight; ?>px;">
								<img src="<?php echo $v->getThumbnail(); ?>" width="<?php echo $videoThumbWidth; ?>" height="<?php echo $videoThumbHeight; ?>" alt="" />
								<span class="cVideoDurationHMS"><?php echo $v->getDurationInHMS(); ?></span>
							</a>
						<?php endif; ?>
					...
					<div class="cVideoSummary">
						...
						<div class="cVideoDetails">
							<div class="cVideoHits"><?php echo JText::sprintf('COM_COMMUNITY_VIDEOS_HITS_COUNT', $v->getHits()) ?></div>                    
							<div class="cVideoLastUpdated"><?php echo JText::sprintf('COM_COMMUNITY_VIDEOS_LAST_UPDATED', $v->getLastUpdated());?></div>
						</div><!-- end .cVideoDetails -->
