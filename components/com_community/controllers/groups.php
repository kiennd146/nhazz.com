...
<?php
	...
	*/
	...
	public function ajaxShowGroupFeatured( $groupId ){
		...
		$objResponse->addScriptCall('updateGroup', $groupId, $group->name, $group->getCategoryName(), $likesHTML, $avatar, $groupDate, $groupLink, CStringHelper::truncate(strip_tags($group->description ), 300) , $membercount, $discussion, $wallposts, $memberCountLink, $groupUnfeature);
