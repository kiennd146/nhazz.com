...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl">
	...
	<div class="SPSearch">
	    ...
	    <div style="clear:both;"/>
	    <xsl:variable name="keyWorld">
		<xsl:value-of select="fields/searchbox/data/input/@value" />
	    </xsl:variable>
	    <xsl:value-of select="php:function('TplFunctions::showNameOfNid', string($keyWorld))" disable-output-escaping="yes"/>
	    <xsl:value-of select="php:function( 'TplFunctions::AddTitle', $keyWorld )" />
