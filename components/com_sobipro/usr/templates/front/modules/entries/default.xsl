			...
			<xsl:for-each select="entries/entry">
                           ...
                           <xsl:variable name="name" select="name"/>
                            <xsl:if test="(position() mod 2) = 1 ">
                                 <div style="float:left;width: 49%;overflow:hidden;height:70px;margin-bottom:5px;margin-top:0px;">
                            ...
                            <xsl:if test="(position() mod 2) = 0 ">
                                 <div style="float:right;width: 49%;overflow:hidden;height:70px;margin-bottom:5px;margin-top:0px;">
                                    <xsl:for-each select="fields/*">
                                            <xsl:if test="data/@icon">
                                                <a>
                                                <xsl:attribute name="href">
