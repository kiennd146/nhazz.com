		...
		function buildmenu($anchors){
			$anchors.each(function(){ //loop through anchor links
				...
				$anchor.bind((setting.trigger=="click")? "click" : "mouseenter", function(e){ //when mouse clicks on or mouses over anchor
					...
					$wrapper.css({visibility:'visible', left:offset.left-(orienttoleft? $wrapper.outerWidth()-$anchor.outerWidth()-ddmegamenu.wrapperoffset[0] : 0)-230, top:offset.top+$anchor.outerHeight(), zIndex:++ddmegamenu.startzindex})
