...
<fieldset class="adminform">
	...
	<a href="http://www.jomsocial.com/support/docs/item/761-system-requirement-for-facebook-connect.html" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC_REQUIREMENT'); ?></a> | <a href="http://www.jomsocial.com/support/docs/item/762-setting-up-facebook-connect.html" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC_SETTING_UP'); ?></a>
