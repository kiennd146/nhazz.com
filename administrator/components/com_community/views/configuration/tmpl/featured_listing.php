			...
			<tr>
				...
				<td valign="top">
					<select name="featuredalbumscroll">
						...
						<option <?php echo ( $this->config->get('featuredalbumscroll') == '4' ) ? 'selected="true"' : ''; ?> value="4">4</option>
						<option <?php echo ( $this->config->get('featuredalbumscroll') == '5' ) ? 'selected="true"' : ''; ?> value="5">5</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td valign="top">
					<select name="featuredvideoscroll">
						...
						<option <?php echo ( $this->config->get('featuredvideoscroll') == '4' ) ? 'selected="true"' : ''; ?> value="4">4</option>
						<option <?php echo ( $this->config->get('featuredvideoscroll') == '5' ) ? 'selected="true"' : ''; ?> value="5">5</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td valign="top">
					<select name="featuredeventscroll">
						...
						<option <?php echo ( $this->config->get('featuredeventscroll') == '4' ) ? 'selected="true"' : ''; ?> value="4">4</option>
						<option <?php echo ( $this->config->get('featuredeventscroll') == '5' ) ? 'selected="true"' : ''; ?> value="5">5</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td valign="top">
					<select name="featuredgroupscroll">
						...
						<option <?php echo ( $this->config->get('featuredgroupscroll') == '4' ) ? 'selected="true"' : ''; ?> value="4">4</option>
						<option <?php echo ( $this->config->get('featuredgroupscroll') == '5' ) ? 'selected="true"' : ''; ?> value="5">5</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td valign="top">
					<select name="featuredmemberscroll">
						...
						<option <?php echo ( $this->config->get('featuredmemberscroll') == '4' ) ? 'selected="true"' : ''; ?> value="4">4</option>
						<option <?php echo ( $this->config->get('featuredmemberscroll') == '5' ) ? 'selected="true"' : ''; ?> value="5">5</option>
					</select>
				</td>
			</tr>
			<tr>
