...
<fieldset class="adminform">
	...
	<a href="http://www.jomsocial.com/support/docs/item/764-system-requirement-for-events.html" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC'); ?></a>
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				...
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'showfeaturedevents' , null , $this->config->get('showfeaturedevents') , JText::_('COM_COMMUNITY_YES_OPTION') , JText::_('COM_COMMUNITY_NO_OPTION') ); ?>
				</td>
			</tr>
