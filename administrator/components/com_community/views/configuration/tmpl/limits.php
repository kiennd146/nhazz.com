...
<fieldset class="adminform">
	...
	<a href="http://www.jomsocial.com/support/docs/item/927-setting-users-action-limits.html" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC'); ?></a>
			...
			<tr>
				...
				<td valign="top">
					<input type="text" name="limit_friends_perday" value="<?php echo $this->config->get('limit_friends_perday');?>" size="4" /> <?php echo JText::_('COM_COMMUNITY_DAILY');?>
                        ...
                        <tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_LIMITS_NEW_FILES' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_LIMITS_NEW_FILES_TIPS'); ?>">
