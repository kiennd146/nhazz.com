...
class plgCommunitySobiProPosts extends CApplications {

    // The user.
    private $_user = null;

    var $name = 'SOBIProPosts';
    var $_name = 'sobiproposts';
    ...
    function plgCommunitySobiProPosts(& $subject, $config) {
    ...
    function onProfileDisplay() {
        ...
        $css = JURI::base() . 'plugins/community/sobiproposts/sobiproposts/style.css';
        $javascript = JURI::base() . 'plugins/community/sobiproposts/sobiproposts/sobiproposts.js';
        $lazyload = JURI::base() . 'plugins/community/sobiproposts/sobiproposts/moolazyloader.js';
        $document->addStyleSheet($css);
        $document->addScript($javascript);
        $document->addScript($lazyload);
        ...
        $this->clear($data);
        $this->clear($this->_user);
        
        return $html;
    }

    function sprintMessage($key) {
        return "<p>" . JText::_('PLG_SOBIPROPOSTS_' . $key) . "</p>";
    }
    ...
    function sprintSobiProTableHeader() {
        //$header_title = JText::_('PLG_SOBIPROPOSTS_HEADER_TITLE');
        //$header_cat = JText::_('PLG_SOBIPROPOSTS_HEADER_CATEGORY');
        //$header_date = JText::_('PLG_SOBIPROPOSTS_HEADER_DATE_ADDED');
        ///$header_image = JText::_('PLG_SOBIPROPOSTS_HEADER_IMAGE');
        $html = <<<html
